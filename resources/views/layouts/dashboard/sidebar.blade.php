  ...
  <aside id="sidebar" class="sidebar">
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
          ...
          <li class="nav-item">
            ...
            @if(!Auth::check() || Auth::user()->canAccessAbsensi())
           <li class="nav-heading">Absensi</li>
              ...
              <li class="nav-item">
                  <a class="{{ (request()->routeIs('absensi-milad-pertama.*') || request()->routeIs('absensi-milad-kedua.*')) ? 'nav-link' : 'nav-link collapsed' }}" data-bs-target="#absensi-milad-nav" data-bs-toggle="collapse" href="#">
                      <i class="bi bi-calendar-check-fill"></i><span>Kepanitiaan MILAD</span><i class="bi bi-chevron-down ms-auto"></i>
                  </a>
                  <ul id="absensi-milad-nav" class="nav-content collapse {{ (request()->routeIs('absensi-milad-pertama.*') || request()->routeIs('absensi-milad-kedua.*')) ? 'show' : '' }}" data-bs-parent="#sidebar-nav">
                      <li>
              ...
              <li class="nav-item">
                  <a class="{{ request()->routeIs('rekapitulasi-absensi.*') ? 'nav-link' : 'nav-link collapsed' }}"
                      href="{{ route('rekapitulasi-absensi.index') }}">
           ...
           @if(!Auth::check() || Auth::user()->canAccessKinerja())
