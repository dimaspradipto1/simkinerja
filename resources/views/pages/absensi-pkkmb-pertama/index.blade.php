            ...
            <div class="card border-0 mb-4 text-white shadow-sm" style="background: linear-gradient(135deg, #198754 0%, #a3cfbb 100%); border-radius: 0.75rem;">
                <div class="card-body p-4 d-flex flex-column gap-3 justify-content-center">
                    <div class="d-flex align-items-start gap-3">
                        <div class="bg-white bg-opacity-20 p-2 rounded-circle d-flex align-items-center justify-content-center text-white fs-4" style="width: 48px; height: 48px; min-width: 48px;">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            let countdown = 60;
            let timer = null;
            const baseUrl = window.location.origin + "{{ route('absensi-pkkmb-pertama.create', [], false) }}";
