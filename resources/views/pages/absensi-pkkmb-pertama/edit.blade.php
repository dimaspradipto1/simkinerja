    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h5 class="card-title fw-bold text-primary mb-4">Form Edit Absensi PKKMB Hari Pertama</h5>

                    <form action="{{ route('absensi-pkkmb-pertama.update', $absensi->id) }}" method="POST" enctype="multipart/form-data" class="row g-4">
                        @csrf
                        @method('PUT')
