...
@section('content')
<div class="pagetitle">
    <h1>Tambah Absensi Kuliah Umum Hari Pertama</h1>
    <nav>
        <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h5 class="card-title fw-bold text-primary mb-4">Form Tambah Absensi Kuliah Umum Hari Pertama</h5>

                    <form action="{{ route('absensi-kuliah-umum-pertama.store') }}" method="POST" enctype="multipart/form-data" class="row g-4">
                        @csrf
