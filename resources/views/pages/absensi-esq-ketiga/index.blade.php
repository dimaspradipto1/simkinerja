...
@section('content')
<div class="pagetitle">
    <h1>Data Absensi ESQ Hari Ketiga</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item active">Absensi Ketiga</li>
        </ol>
    </nav>
</div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
            ...
            <div class="card border-0 mb-4 text-white shadow-sm absensi-mobile-banner" style="background: linear-gradient(135deg, #198754 0%, #a3cfbb 100%); border-radius: 0.75rem;">
                <div class="card-body p-4 d-flex flex-column gap-3 justify-content-center">
                    ...
                    <div>
                        <a href="{{ route('absensi-esq-ketiga.scan') }}?start=1" class="btn btn-light rounded-pill px-4 py-2 font-semibold shadow-sm d-inline-flex align-items-center gap-2" style="color: #198754; font-weight: 600;">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    <h5 class="card-title m-0 p-0 fs-5 font-semibold text-primary">List Absensi Hari III</h5>
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <!-- Export Excel Button -->
                        <a href="{{ route('absensi-esq-ketiga.export-excel') }}" class="btn btn-success rounded btn-sm d-inline-flex align-items-center gap-1 font-medium bg-emerald-600 hover:bg-emerald-700 border-0">
                            <i class="bi bi-file-earmark-excel"></i> Export Excel
                        </a>
                        <!-- Add Button -->
                        <a href="{{ route('absensi-esq-ketiga.create') }}" class="btn btn-primary rounded btn-sm d-inline-flex align-items-center gap-1 font-medium">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow-lg" style="border-radius: 1rem;">
            <div class="modal-header border-0 pb-0 justify-content-center position-relative pt-4">
                <h5 class="modal-title font-bold text-center w-100" id="qrModalLabel" style="color: #1e3a8a; font-weight: 700; font-size: 1.35rem;">QR Absensi Hari 3 (Waktu Datang)</h5>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#btn-session-datang').on('click', function() {
                ...
                // UI updates
                $('#qrModalLabel').text('QR Absensi Hari 3 (Waktu Datang)');
            ...
            $('#btn-session-pulang').on('click', function() {
                ...
                // UI updates
                $('#qrModalLabel').text('QR Absensi Hari 3 (Waktu Pulang)');
            ...
            setInterval(function() {
                if ($.fn.DataTable.isDataTable('#absensiesqketiga-table')) {
                    $('#absensiesqketiga-table').DataTable().ajax.reload(null, false);
                }
            }, 5000);
        });
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#absensiesqketiga-table').DataTable().ajax.reload();
                            } else {
                                Swal.fire({
                                    title: 'Gagal!',
