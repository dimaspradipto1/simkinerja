...
@section('content')
<div class="pagetitle">
    <h1>Edit Absensi ESQ Hari Kedua</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Home</a></li>
            <li class="breadcrumb-item"><a href="{{ route('absensi-esq-kedua.index') }}">Absensi Kedua</a></li>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h5 class="card-title fw-bold text-primary mb-4">Form Edit Absensi ESQ Hari Kedua</h5>

                    <form action="{{ route('absensi-esq-kedua.update', $absensi->id) }}" method="POST" enctype="multipart/form-data" class="row g-4">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-12 mt-4 d-flex gap-2">
                            ...
                            <a href="{{ route('absensi-esq-kedua.index') }}" class="btn btn-secondary px-4"><i class="bi bi-arrow-left me-1"></i> Kembali</a>
                        </div>
                    </form>
