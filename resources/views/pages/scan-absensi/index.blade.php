            ...
            <div class="card shadow-sm border-0" style="border-radius: 1rem;">
                <div class="card-body p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <a href="{{ route('dashboard') }}" class="btn btn-secondary btn-sm d-inline-flex align-items-center gap-1 py-1 px-3 rounded shadow-sm">
                    ...
                    <div class="text-center my-4">
                        <h6 class="fw-bold text-dark m-0" style="font-size: 1.1rem; color: #1e3a8a !important;">Silakan Scan Terhadap QR Panitia</h6>
                        <p class="text-muted small mt-2 mb-0">Scanner ini berlaku untuk semua kegiatan (PKKMB, ESQ, MILAD, Kuliah Umum, dst).</p>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        const qrCodeSuccessCallback = (decodedText, decodedResult) => {
            // Stop scanning and redirect. The QR itself encodes the
            // full target URL (the specific event's scan-proses endpoint).
