...
@section('content')
<div class="pagetitle">
    <h1>Data Absensi Hari Ketiga</h1>
    <nav>
        <ol class="breadcrumb">
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <!-- Export Excel Button -->
                        <a href="{{ route('absensi-pkkmb-ketiga.export-excel') }}" class="btn btn-success rounded btn-sm d-inline-flex align-items-center gap-1 font-medium bg-emerald-600 hover:bg-emerald-700 border-0">
                            <i class="bi bi-file-earmark-excel"></i> Export Excel
                        </a>
                        <!-- Add Button -->
                        <a href="{{ route('absensi-pkkmb-ketiga.create') }}" class="btn btn-primary rounded btn-sm d-inline-flex align-items-center gap-1 font-medium">
    ...
    <script>
        $(document).ready(function() {
            ...
            setInterval(function() {
                if ($.fn.DataTable.isDataTable('#absensipkkmbketiga-table')) {
                    $('#absensipkkmbketiga-table').DataTable().ajax.reload(null, false);
                }
            }, 5000);
        });
        ...
        function deleteAbsensi(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: "{{ url('absensi-pkkmb-ketiga') }}/" + id,
                        type: 'DELETE',
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#absensipkkmbketiga-table').DataTable().ajax.reload();
                            } else {
                                Swal.fire({
                                    title: 'Gagal!',
