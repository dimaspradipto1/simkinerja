    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow-sm border-0">
                <div class="card-body">
                    <h5 class="card-title fw-bold text-primary mb-4">Form Edit Absensi PKKMB Hari Ketiga</h5>

                    <form action="{{ route('absensi-pkkmb-ketiga.update', $absensi->id) }}" method="POST" enctype="multipart/form-data" class="row g-4">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="row g-3 align-items-center">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @else
                                        <span class="text-muted small italic d-block mt-2">Tidak ada berkas yang dilampirkan</span>
                                    @endif
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-12 mt-4 d-flex gap-2">
                            ...
                            <a href="{{ route('absensi-pkkmb-ketiga.index') }}" class="btn btn-secondary px-4"><i class="bi bi-arrow-left me-1"></i> Kembali</a>
                        </div>
                    </form>
