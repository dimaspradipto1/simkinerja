...
class AbsensiEsqPertamaDataTable extends DataTable
{
    /**
     * Build the DataTable class.
     *
     * @param QueryBuilder<AbsensiEsqPertama> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                $editUrl = route('absensi-esq-pertama.edit', $row->id);
     ...
     *
     * @return QueryBuilder<AbsensiEsqPertama>
     */
    public function query(AbsensiEsqPertama $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('absensiesqpertama-table')
    ...
    {
        return 'AbsensiEsqPertama_' . date('YmdHis');
    }
}
