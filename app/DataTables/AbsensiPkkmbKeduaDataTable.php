...
class AbsensiPkkmbKeduaDataTable extends DataTable
{
    /**
     * Build the DataTable class.
     *
     * @param QueryBuilder<AbsensiPkkmbKedua> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                $editUrl = route('absensi-pkkmb-kedua.edit', $row->id);
     ...
     *
     * @return QueryBuilder<AbsensiPkkmbKedua>
     */
    public function query(AbsensiPkkmbKedua $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('absensipkkmbkedua-table')
    ...
    {
        return 'AbsensiPkkmbKedua_' . date('YmdHis');
    }
}
