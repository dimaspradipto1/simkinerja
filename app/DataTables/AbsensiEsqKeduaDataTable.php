...
class AbsensiEsqKeduaDataTable extends DataTable
{
    /**
     * Build the DataTable class.
     *
     * @param QueryBuilder<AbsensiEsqKedua> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                $editUrl = route('absensi-esq-kedua.edit', $row->id);
     ...
     *
     * @return QueryBuilder<AbsensiEsqKedua>
     */
    public function query(AbsensiEsqKedua $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('absensiesqkedua-table')
    ...
    {
        return 'AbsensiEsqKedua_' . date('YmdHis');
    }
}
