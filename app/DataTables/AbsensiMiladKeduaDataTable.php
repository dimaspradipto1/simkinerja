...
class AbsensiMiladKeduaDataTable extends DataTable
{
    /**
     * Build the DataTable class.
     *
     * @param QueryBuilder<AbsensiMiladKedua> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                $editUrl = route('absensi-milad-kedua.edit', $row->id);
     ...
     *
     * @return QueryBuilder<AbsensiMiladKedua>
     */
    public function query(AbsensiMiladKedua $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('absensimiladkedua-table')
    ...
    {
        return 'AbsensiMiladKedua_' . date('YmdHis');
    }
}
