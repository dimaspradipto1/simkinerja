...
class AbsensiPkkmbKetigaDataTable extends DataTable
{
    /**
     * Build the DataTable class.
     *
     * @param QueryBuilder<AbsensiPkkmbKetiga> $query Results from query() method.
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                $editUrl = route('absensi-pkkmb-ketiga.edit', $row->id);
     ...
     *
     * @return QueryBuilder<AbsensiPkkmbKetiga>
     */
    ...
    {
        return $this->builder()
                    ->setTableId('absensipkkmbketiga-table')
    ...
    {
        return 'AbsensiPkkmbKetiga_' . date('YmdHis');
    }
}
